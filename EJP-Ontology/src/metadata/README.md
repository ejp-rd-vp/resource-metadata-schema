 ...
 * [ejp-rd.yml](ejp-rd.yml)
     * Determines how your purl.obolibrary.org/obo/ejp-rd/ redirects will be handled
     ...
     * Paste in the contents of [ejp-rd.yml](ejp-rd.yml)
 ...
 * [ejp-rd.md](ejp-rd.md)
     ...
     * Paste in the contents of [ejp-rd.md](ejp-rd.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
